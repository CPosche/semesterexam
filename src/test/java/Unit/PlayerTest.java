...
public class PlayerTest {
    ...
    public void testPlayer() {
        ...
        Player player = pc.create("newtestPlayer", "40506968", "newtest@newtest.dk", "ok");
    ...
    public void testUpdatePlayer(){
        EntityManagerFactory emf = EMF_Creator.createEntityManagerFactoryForTest();
        PlayerController pc = PlayerController.getPlayerController(emf);
        PlayerDTO playerDTO = new PlayerDTO("updatedtestPlayer", "40516967", "updated1@updated1.dk", "notok");
        Player player = pc.update(1, playerDTO);
