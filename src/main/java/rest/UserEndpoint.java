...
//            try {
//                String faceitId = UserController.getFaceitId(json.get("faceitnickname").getAsString());
...
//            EntityManager em = EMF_Creator.createEntityManagerFactory().createEntityManager();
//            User user = em.find(User.class, id);
//            FaceitUser faceitUser = new FaceitUser(nickname, UserController.getFaceitId(nickname));
//            em.getTransaction().begin();
